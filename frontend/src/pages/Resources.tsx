        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-16">
            <motion.div
              ...
              > 
            <h1 className="text-4xl font-bold text-blue-600 mb-4">Resources</h1>
    ...
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
      ...
      >
        <div className="p-6">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Computer Basics & Hardware</h3>
          <p className="text-gray-600 mb-4">
            Learn foundational computer skills, including how hardware and operating systems work.
          </p>
      ...
      >
        <div className="p-6">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Internet & Email Skills</h3>
          <p className="text-gray-600 mb-4">
            Gain essential internet skills, from browsing safely to using email effectively.
          </p>
          <ul className="space-y-2 text-sm text-gray-600">
            <li>• Web Browsing Basics</li>
            <li>• Email Setup & Usage</li>
            <li>• Internet Safety & Privacy</li>
